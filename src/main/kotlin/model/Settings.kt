...
private val DEFAULT_VIEW_TEMPLATE = "package ${FileNames.PACKAGE_NAME.value}\n\ninterface ${FileNames.NAME.value}${FileNames.SCREEN_ELEMENT.value}"

private fun defaultScreenElements() = mutableListOf(
        ScreenElement("MVP", DEFAULT_MVP_TEMPLATE, FileType.KOTLIN, "${FileNames.NAME.value}${FileNames.ANDROID_COMPONENT_NAME.value}"),
